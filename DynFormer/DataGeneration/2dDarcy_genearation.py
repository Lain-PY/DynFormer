"""
This code is adapted from: https://github.com/neuraloperator/neuraloperator/blob/main/neuralop/data/datasets/darcy.py
The dataset can be directly loaded from: https://zenodo.org/records/12784353
"""
import logging
import os
